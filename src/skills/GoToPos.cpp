...
GoToPos::GoToPos(std::string name, bt::Blackboard::Ptr blackboard)
        ...
        {
            ROS_DEBUG_STREAM_NAMED("skills.GoToPos", "New GoToPos started for robot " << blackboard->GetInt("ROBOT_ID"));
            ROS_DEBUG_STREAM_NAMED("skills.GoToPos", "Blackboard : " << blackboard->toString());
