...
bool Leaf::GetBool(std::string key, bool def, BlackboardPolicy policy) {
    return GetOrDefault<bool, &bt::Blackboard::HasBool, &bt::Blackboard::GetBool>(key, def, policy);
}
...
int Leaf::GetInt(std::string key, int def, BlackboardPolicy policy) {
    return GetOrDefault<int, &bt::Blackboard::HasInt, &bt::Blackboard::GetInt>(key, def, policy);
}
...
float Leaf::GetFloat(std::string key, float def, BlackboardPolicy policy) {
    return GetOrDefault<float, &bt::Blackboard::HasFloat, &bt::Blackboard::GetFloat>(key, def, policy);
}
...
double Leaf::GetDouble(std::string key, double def, BlackboardPolicy policy) {
    return GetOrDefault<double, &bt::Blackboard::HasDouble, &bt::Blackboard::GetDouble>(key, def, policy);
}
...
std::string Leaf::GetString(std::string key, std::string def, BlackboardPolicy policy) {
    return GetOrDefault<std::string, &bt::Blackboard::HasString, &bt::Blackboard::GetString>(key, def, policy);
}
