...
int main() {
	Vector2 startPoint = Vector2(0.0, 0.0);
	Vector2 centerPoint = Vector2(2.0, 0.0);
	double distance = 0.5;
	rtt::Cone cone(startPoint, centerPoint, distance);

	// Vector2 startPoint2 = Vector2(0.0, 0.0);
	// Vector2 centerPoint2 = Vector2(2.0, 1.0);
	...
	// Vector2 cone1Side1 = (cone.center-cone.start).rotate(cone.angle);
	// cone1Side1 = cone1Side1.scale(1/cone1Side1.length());
	// Vector2 cone1Side2 = (cone.center-cone.start).rotate(-cone.angle);
	// cone1Side2 = cone1Side2.scale(1/cone1Side2.length());
	// Vector2 cone2Side1 = (cone2.center-cone2.start).rotate(cone2.angle);
	// cone2Side1 = cone2Side1.scale(1/cone2Side1.length());
	// Vector2 cone2Side2 = (cone2.center-cone2.start).rotate(-cone2.angle);
	// cone2Side2 = cone2Side2.scale(1/cone2Side2.length());
	// Vector2 cone3Side1 = (cone3.center-cone3.start).rotate(cone3.angle);
	// cone3Side1 = cone3Side1.scale(1/cone3Side1.length());
	// Vector2 cone3Side2 = (cone3.center-cone3.start).rotate(-cone3.angle);
